...
void Jac1 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)

{
 ...
 /*------ declarations -------------------------------------------------*/ 
     ...
     lowfloat C1,C2,C3,C4,C5,C6,C7;
     lowfloat Q1,Q2,P1,P2,Q12;
     lowfloat cosQ1Q2,sinQ1Q2,cosQ1,cosQ2;
     lowfloat aux0,aux1,dQ1aux1,aux2,aux3;
     lowfloat daux5,daux6,daux9,daux10,daux17,daux22;
     lowfloat daux33,daux34,daux37,daux38,daux41,daux42;
     lowfloat daux45,daux46,daux49,daux50,daux53,daux54,daux55,daux56;
     lowfloat daux66,daux69,daux80,daux83,daux89,daux104;
...
void Jac2 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
...
void Jac3 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac4 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac5 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac6 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac7 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac8 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac9 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
...
void Jac10 (int neq, val_type t,val_type *u,lowfloat *Jac,parameters *params)
{
     return;
}
